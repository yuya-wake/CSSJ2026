...
os.makedirs('results/qwen2', exist_ok=True)
OUTPUT_RESULT_PATH = 'results/qwen2/summary_results.csv'
OUTPUT_METRICS_PATH = 'results/qwen2/summary_metrics_summary_qwen2.csv'

MODEL_PATHS = {"qwen2": "/path/to/local_models/qwen2-7b-instruct-q5_k_m.gguf"}
...
def main():
    ...
    for model_name, model_path in MODEL_PATHS.items():
        ...
        truncated_log_path = f'results/qwen2/truncated_log_{model_name}.csv'

...
os.makedirs('results/gpt-oss', exist_ok=True)
OUTPUT_RESULT_PATH = 'results/gpt-oss/summary_results.csv'
OUTPUT_METRICS_PATH = 'results/gpt-oss/summary_metrics_summary_gpt-oss.csv'

MODEL_PATHS = {"gpt-oss": "/path/to/local_models/gpt-oss-20b-Q4_K_M.gguf"}

MODEL_CONTEXT_LIMITS = 32768
# MODEL_CONTEXT_LIMITS = {d
#     "qwen2": 32768,
#     "calm3": 16384,
#     "gpt-oss": 32768
# }
...
def create_prompt_and_truncate(row, model, context_limit):
    ...
    # 2. 固定部分のトークン数を計算
    # llama-cppのtokenizerはbytes列を返すことがあるのでlenをとる
...
def main():
    ...
    for model_name, model_path in MODEL_PATHS.items():
        ...
        truncated_log_path = f'results/gpt-oss/truncated_log_{model_name}.csv'

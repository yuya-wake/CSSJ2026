...
OUTPUT_RESULT_PATH = 'results/calm3_hf/baseline_strict_results.csv'
OUTPUT_METRICS_PATH = 'results/calm3_hf/baseline_strict_metrics_summary_calm3_hf.csv'
...
# 定義プロンプト
# ======================================================================
with open("prompt/prompt_strict.txt", 'r', encoding='utf-8') as f:
